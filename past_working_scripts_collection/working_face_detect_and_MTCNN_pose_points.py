# Usage 
'''
python working_face_detect_and_MTCNN_pose_points.py --image_size 300 \
--margin 32 --random_order --gpu_memory_fraction 0.3 --detect_multiple_faces true
'''
...
def main(args):
    ...
    #fa = FaceAligner(desiredFaceWidth=150, desiredFaceHeight=150)
