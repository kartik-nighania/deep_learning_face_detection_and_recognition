...
def train():
   ...
   model = input("Enter the folder path where the folder 20180402-114759 model is present. Press ENTER stating that this folder is present in this code directory itself: ").rstrip()
   if model == "":
